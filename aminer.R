...
# 载入scientist_pub数据
scientist_pub <- read_csv("/Users/chenjian/github/idaccuracy2-chenjiancqu/scientist_pub.csv")

# 获取Aminer文件夹下的所有文件
files <- list.files(path = "/Users/chenjian/github/idaccuracy2-chenjiancqu/Aminer", 
